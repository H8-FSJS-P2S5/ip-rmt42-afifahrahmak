                ...
                <div className="d-flex" style={{ gap: "30px" }}>
                    <div className="col-md-3">
                        <div className="container">
                            ...
                            <button className="btn btn-warning btn-sm mb-4">Add Post</button>
                    ...
                    <div className="col-md-8">
                        <div className="container">
                            ...
                            <div>
                                <select style={{ color: "white", backgroundColor: "transparent", borderRadius: "2px" }} onChange={(e) => setSort(e.target.value)} className="ms-3">
